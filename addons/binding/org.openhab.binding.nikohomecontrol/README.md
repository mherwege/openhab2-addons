...
The Niko Home Control II bridge does not yet support rollershutters, thermostats and notification trigger channels.
...
Bridge nikohomecontrol:bridge2:nhc2 [ addr="192.168.0.70", port=8883, touchprofile="openHAB", password="mypassword", refresh=300 ] {
    onOff 1 "Office" @ "Downstairs" [ actionId="12345678-abcd-1234-ef01-aa12bb34cc56" ]
    dimmer 2 "DiningRoom" [ actionId="abcdef01-abcd-1234-ab98-abcdef012345", step=5 ]
}
